...
function loadDetail(length,_list){
	...
	for (var i = 0; i < length; i++){
		...
		// $("#companySituation").empty().append(_list[i].companySituation);
		// $("#consultantTeam").empty().append(_list[i].consultantTeam);
		// $("#successfulCase").empty().append(_list[i].successfulCase);
		// $("#successfulCase").empty().append(_list[i].successfulCase);
		
		console.log("---"+_list[i].successfulCase);
