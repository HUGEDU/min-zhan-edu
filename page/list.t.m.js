var list_t= '<div class="" id="searchs"><ul class="T-m-reveal"><li class="T-m-r-logo">'
             +'<h1><a href="$detailUri"><img src="$imgUrl" title="$shortCompanyName"></a></h1><h2>$certificateNO</h2>'
			 +'</li>'
			+'<li class="T-m-r-cont">'
            ...
            +'<dl class="c"><dt>提供服务：</dt><dd>$serviceItem</dd></dl>'
            +'<dl class="c"><dt>擅长学科：</dt><dd>$bestSubject</dd></dl></li></ul></div>'
            +'';
